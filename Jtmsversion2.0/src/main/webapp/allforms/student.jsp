	               	 ...
	               	 <form action="/showStatus" method="post">
	                 	...
	                 	<div class="col-md-6 pr-1">
	                      <div class="form-group">
	                        ...
	                        <input type="text" class="form-control" style = "text-transform:capitalize;" placeholder="Student Full Name" name="searchedName" required="required">
	                      </div>
                    	</div>
	                 	...
	                 	<div class="col-md-6 px-1">
	                      <div class="form-group">
	                        <label>Email</label>
	                        <input type="text" class="form-control" placeholder="Mail Address" name="searchedEmail" required="required">
	                      </div>
                    	</div>
                    	</div>
                    	<p class="text-danger text-right">&nbsp</p>
                    	<div class="row" >
