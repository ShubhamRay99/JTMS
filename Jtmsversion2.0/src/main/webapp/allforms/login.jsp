  ...
  <nav class="navbar navbar-expand-lg navbar-absolute fixed-top navbar-transparent">
    <div class="container">
      <div class="navbar-wrapper">
        ...
        <a class="navbar-brand" href="https://javatechnocrat.com/">Java Technocrat</a>
      </div>
  ...
  <div class="page-header clear-filter">
    ...
    <div class="container text-center">
      <div class="col-md-8 ml-auto mr-auto">
        <form class="box" action="logging" method="post" autocomplete="off">
			
			<input type="text" name="name" placeholder="username">
			<input type="password" name="password" placeholder="password">
			<div class="row">	
	     		<div class="update ml-auto mr-auto">
        			<input type="submit" class="btn btn-success btn-outline-success btn-round btn-wd " value = "Login">
           		</div>
           	</div>
			<h5>Click here to <a href="register">Register</a></h5>
			<h><a href="forgetPassword">Forget password</a></h5>
			
		</form>
      </div>
      <p style="padding-top: 200px;padding-left: 355px;padding-right: 350px;">
