        ...
        <div class="row">
          <div class="col-md-4" >
            <div class="card ">
              ...
              <div class="card-footer ">
                <div class="legend">
                  <i class="fa fa-circle text-primary"></i> Java	
                  <i class="fa fa-circle text-warning"></i> Adv Java 
                  <i class="fa fa-circle text-danger"></i> Python
                  <i class="fa fa-circle text-gray"></i> Android
                </div>
                <hr>
                <div class="stats">
          ...
          <div class="col-md-8" >
            <div class="card card-chart" >
              <div class="card-header">
                <h5 class="card-title">Advertising Agencies</h5>
             ...
             <div class="card-body">
              ...
              <div class="card-footer">
                <div class="chart-legend">
                  <i class="fa fa-circle text-info"></i> Web Hosting 
                  <i class="fa fa-circle text-warning"></i> College Conference
                </div>
                <hr/>
          ...
          <div class="col-md-11" style="padding-left: 45px;padding-top: 1px">
            <div class="card " >
              <div class="card-header ">
