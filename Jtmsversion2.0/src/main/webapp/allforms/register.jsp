  ...
  <div class="page-header clear-filter">
    ...
    <div class="container text-center">
      <div class="col-md-8 ml-auto mr-auto">
        <form class="box" action="registering" method="post" autocomplete="off">
			...
			<div class="row">	
                    		<div class="update ml-auto mr-auto">
                    			<input type="submit" class="btn btn-success btn-outline-success btn-round btn-wd " value = "Register">
                    		</div>
            </div>
