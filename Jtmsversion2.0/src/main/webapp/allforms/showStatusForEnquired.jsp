	               	 ...
	               	 <form action="/showStatus" method="post">
	                 	...
	                 	<div class="col-md-6 pr-1">
	                      <div class="form-group">
	                        ...
	                        <input type="text" class="form-control" style = "text-transform:capitalize;" placeholder="Student Name" name="searchedName" required="required">
	                      </div>
                    	</div>
            ...
            <div class="card card-user">
              <div class="card-header">
                <div class="text-right" style="padding-right: 20px;">
                	<p style="color: purple;" id="status">The entity had taken a enquiry earlier.</p>
                	</div>
                <h5 class="card-title">Enter Your Personal Details</h5>
              </div>
              <div class="card-body">
                <form action="/EnquiredRegistrationDetails" method="post">
                  <div class="row">
                    <div class="col-md-4 pr-1">
                      <div class="form-group">
                        <label>Student name</label>
                        <input type="text" class="form-control" style = "text-transform:capitalize;" placeholder="Enter Your Full Name" name="name"  value="${student.name}" required="required">
                      </div>
                    </div>
                    <div class="col-md-4 pl-1">
                      <div class="form-group">
                        <label for="exampleInputEmail1">Email address</label>
                        <input type="email" class="form-control" name="email" placeholder="Enter a valid Email" value="${student.email}" required="required">
                      </div>
                    </div>
                    <div class="col-md-4 pl-1">
                      <div class="form-group">
                        <label for="exampleInputEmail1">Mobile Number</label>
                        <input type="number" class="form-control" placeholder="Enter A valid Phone number" name="phone" value="${student.mobile}" required="required">
                      </div>
                    </div>
                  </div>
                  <div class="row">
                    <div class="col-md-5 pr-1">
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control" style = "text-transform:uppercase;" placeholder="Enter College Name" name="college" value="${student.college}" required="required">
                      </div>
                    </div>
                    <div class="col-md-4 pl-1">
                      <div class="form-group">
                        <label>Branch</label>
                        <input type="text" class="form-control" style = "text-transform:uppercase;" placeholder="Enter Your Branch" name="branch"  value="${student.branch}" required="required">
                      </div>
                    </div>
                  ...
                  <div class="row">
                    ...
                    <div class="col-md-4 px-1">
                      <div class="form-group">
                        ...
                        <input type="number" class="form-control" placeholder="Enter Your Parent's Phone Number" name="guardian_phone" value="${parent.guardian_phone}" required="required">
                      </div>
                    </div>
                    <div class="col-md-4 pl-1">
                      <div class="form-group">
                  ...
                  <div class="row">
                    <div class="update ml-auto mr-auto">
						<button formaction="/EnquiredRegistrationDetails" class="btn btn-primary btn-outline-primary btn-round btn-wd " >Register</button>
                    </div>
                  </div>
